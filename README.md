...
**⚠️ Сканирование всех образов во всех проектах (ОСТОРОЖНО!):**
```bash
# ⚠️ ВНИМАНИЕ: Это может занять очень много времени и ресурсов!
# Рекомендуется использовать сканирование конкретных проектов
